            ...
            <div>
                <div class="text-lg space-y-6">
                    <form method="POST" action="/listings/{{$listing->id}}/comment" enctype="multipart/form-data">
                        @csrf
                        <div class="bg-light p-2 pt-4 row">
                            <div class="d-flex flex-row align-items-start col-lg-8">
                                <img class="rounded-circle border border-dark ms-3 me-6"
                                    ...
                                    width="50"
                                >
                                <input class="form-control shadow-none textarea "
                                    name="userComment"
                            ...
                            <div class="mt-1 text-right col-lg-1">
