                ...
                <div class="col-span-4 sm:col-span-3">
                    <div class="bg-white shadow rounded-lg p-6">
                        <div class="flex flex-col items-center">
                            <img
                                src="{{asset('images/mypicture.jpg')}}"
                                class="w-32 h-32 bg-gray-300 rounded-full mb-4 shrink-0 hover:bg-indigo-600 transition duration-500 hover:scale-125">
                            </img>
                ...
                <div class="col-span-4 sm:col-span-9">
                    <div class="bg-white shadow rounded-lg p-6">
                        ...
                        <div class="flex justify-center items-center gap-6 my-6">
                            <a class="text-gray-700 hover:text-orange-600" aria-label="Visit TrendyMinds LinkedIn" href="https://www.linkedin.com/in/ezel-espera-30a9b6200/"
                                target="_blank">
                            ...
                            <a class="text-gray-700 hover:text-orange-600" aria-label="Visit TrendyMinds YouTube" href="https://www.youtube.com/channel/UC_OItB-lfjQkKXUX9D9pK1Q"
                                target="_blank">
                            ...
                            <a class="text-gray-700 hover:text-orange-600" aria-label="Visit TrendyMinds Facebook" href="https://www.facebook.com/ezel.i.mozo"
                                target="_blank">
                            ...
                            <a class="text-gray-700 hover:text-orange-600" aria-label="Visit TrendyMinds Instagram" href="https://www.instagram.com/ezelmozo/"
                                target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="h-6">
                                    <path fill="currentColor"
                            ...
                            <a class="text-gray-700 hover:text-orange-600" aria-label="Visit TrendyMinds Twitter" href="https://twitter.com/EzelMozo"
                                target="_blank">
                        ...
                        <div class="mb-6">
                            <div class="flex justify-between flex-wrap gap-2 w-full">
                                <span class="text-gray-700 font-bold">Junior Software Engineer</span>
                                <p>
                                    <span class="text-gray-700 mr-2">at JPLUSPLUS-IT-Solutions-Inc</span>
                                    <span class="text-gray-700">May 2024 - present</span>
                                </p>
                            </div>
                            <p class="mt-2">
                                Assist the development team with all aspects of software design and coding.
                                My primary role is to learn the codebase, attend design meetings, write basic code, fix bugs, and assist the Development Manager in all design-related tasks.
                            </p>
                        </div>
                        <div class="mb-6">
                            <div class="flex justify-between flex-wrap gap-2 w-full">
                                <span class="text-gray-700 font-bold">IT Specialist </span>
                                <p>
                                    <span class="text-gray-700 mr-2">at Bright Speed Inc. (Grab) </span>
                                    <span class="text-gray-700">May 2016 - September 2017 </span>
                                </p>
                            </div>
                            <p class="mt-2">
                                Formulated an excel file to optimize the process of computing the daily remittances report.
                                 Perform different role from IT to Admin Staff.
                                Able to accomplish challenges for the recruitment process.
                            </p>
                        </div>
                        <div class="mb-6">
                            <div class="flex justify-between flex-wrap gap-2 w-full">
                                <span class="text-gray-700 font-bold">INTERNSHIP</span>
                                <p>
                                    <span class="text-gray-700 mr-2">at National Telecommunication Commission</span>
                                    <span class="text-gray-700">April 2012 - June 2012</span>
                                </p>
                            </div>
                            <p class="mt-2">
                                Database management using Microsoft Access 2013. Designate bandwidth to the newly licensed radio channels. Produce ID for the newly licensed radio operators.
                            </p>
                        </div>
                    </div>
                </div>
